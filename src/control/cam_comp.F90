...
! #endif /* defined(MMF_SAMXX) || defined(MMF_PAM) */
...
! #if defined(MMF_SAMXX) || defined(MMF_PAM)
   ! E3SM ported phys_run2 uses dtime instead of dtime_phys
...
! #endif /* defined(MMF_SAMXX) || defined(MMF_PAM) */
   ! ! This is the original phys_run2 call in CESM
...
#endif /* defined(MMF_ML_TRAINING) || defined(MMF_NN_EMULATOR) */
