module physics_update_mod 
  ...
  implicit none
  private
  public  :: physics_update_init, physics_update_ml, get_var
...
contains 
  ...
  subroutine physics_update_ml(state, ptend, dt, tend)
    !purpose: This subroutine calls physics_update (old physics_update)
    !reverted back from physics_update_main in E3SM
    ...
    !if nothing is to be updated in physics_update, DO NOT output (using outfld calls) 
    ...
    !call the old physics update call (reverted from physics_update_main from E3SM)
  ...
  end subroutine physics_update_ml
